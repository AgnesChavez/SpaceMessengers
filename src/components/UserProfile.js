...
//             let state = {
//             displayName: this.state.dbUser.displayName,
...
//             
//             this.updateUserDb("displayName", this.state.dbUser.displayName);
// 
...
//                              this.userProp("Name",  this.state.dbUser , "displayName", true, this.handleChangeUser ):""
//                         }
